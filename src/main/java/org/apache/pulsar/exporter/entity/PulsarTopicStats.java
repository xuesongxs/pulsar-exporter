...
package org.apache.pulsar.exporter.entity;
...
public class PulsarTopicStats {
    ...
    private ArrayList<PulsarPublisherStats> publishers;

    /** Map of subscriptions with their individual statistics */
    private HashMap<String, PulsarSubscriptionStats> subscriptions;

    /** Map of replication statistics by remote cluster context */
    private HashMap<String, PulsarReplicatorStats> replication;
