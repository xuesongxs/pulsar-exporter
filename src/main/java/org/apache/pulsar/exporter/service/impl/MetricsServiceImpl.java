...
package org.apache.pulsar.exporter.service.impl;

import io.prometheus.client.Collector;
import io.prometheus.client.CollectorRegistry;
import org.apache.pulsar.exporter.collector.PulsarMetricsCollector;
...
@Service
public class MetricsServiceImpl implements PulsarMetricsService {
    private CollectorRegistry registry = new CollectorRegistry();
    private final PulsarMetricsCollector metricsCollector;

    public PulsarMetricsCollector getCollector() {
        return metricsCollector;
    }

    public MetricsServiceImpl() {
        metricsCollector = new PulsarMetricsCollector();
